...
var background = new Sprite({ x: 0, y: 0 }, '../assets/background.png');
var shop = new Sprite({ x: 650, y: 160 }, '../assets/shop.png', 2.5, 6);
var player = new Fighter({ x: 180, y: 200 }, { x: 0, y: 10 }, 'red', { x: 50, y: 0 }, '../assets/samuraiMack/idle.png', 2.5, 8, { x: 215, y: 157 }, {
...
var enemeyHealth = document.getElementById('enemy-health');
var timerElement = document.getElementById('timer');
var gameOverState = document.getElementById('game-state');
var timer = 50;
var keys = {
    a: {
        pressed: false
